...
class S3DISDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return current_points[:,:3], current_labels, current_points[:,6:9],current_points[:,3:6]
        # order : point, label, normal, color rgb
...
if __name__ == '__main__':
    data_root = '/cluster/51/ge89pam/pointMLP-pytorch/part_segmentation/data/new/stanford_indoor3d/'
    num_point, test_area, block_size, sample_rate = 2048, 5, 1.0, 0.01
    ...
    print('point point 0 shape:', point_data.__getitem__(0)[0].shape)
    print('point label 0 shape:', point_data.__getitem__(0)[1].shape)
    print('point normal 0 shape:', point_data.__getitem__(0)[2].shape)
    print('point color 0 shape:', point_data.__getitem__(0)[3].shape)
